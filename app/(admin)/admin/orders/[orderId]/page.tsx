              ...
              <form action={updateOrderStatus.bind(null, order.id, 'cancelled')}>
                <ConfirmSubmitButton
                  ...
                  description={order.status === 'pending'
                    ? 'The customer will be notified and the order status will be set to cancelled.'
                    : `This order is already ${order.status}. Cancelling will notify the customer, remove it from revenue totals, and keep it visible here as a cancelled record.`}
