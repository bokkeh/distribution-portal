          ...
          <CardContent className="space-y-4">
            ...
            {order.status === 'pending' && (
              <form action={updateOrderStatus.bind(null, order.id, 'cancelled')}>
                <ConfirmSubmitButton variant="destructive" className="w-full" title="Cancel this order?" description="The customer will be notified and the order status will be set to cancelled." confirmLabel="Cancel Order">Cancel Order</ConfirmSubmitButton>
              </form>
            )}
          </CardContent>
        </Card>
