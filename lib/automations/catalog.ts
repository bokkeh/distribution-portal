...
export const EMAIL_AUTOMATIONS = [
  ...
  { id: 'email:delivery_completed', channel: 'Email', audience: 'Customers', name: 'Delivery completed', trigger: 'Sent when a delivery is marked complete.', portalDestination: '/customer/orders', adminDestination: '/admin/automations/emails' },
  { id: 'email:driver_assignment', channel: 'Email', audience: 'Drivers', name: 'Driver assignment', trigger: 'Sent when a driver is assigned a delivery route.', portalDestination: '/driver/deliveries', adminDestination: '/admin/automations/emails' },
  { id: 'email:taster_assignment', channel: 'Email', audience: 'Tasters', name: 'Tasting assignment', trigger: 'Sent when a taster is assigned to a tasting.', portalDestination: '/taster/tastings', adminDestination: '/admin/automations/emails' },
  { id: 'email:tasting_status', channel: 'Email', audience: 'Tasters', name: 'Tasting status update', trigger: 'Sent when a tasting is confirmed, cancelled, or declined.', portalDestination: '/taster/tastings', adminDestination: '/admin/automations/emails' },
  { id: 'email:tasting_report_received', channel: 'Email', audience: 'Tasters', name: 'Tasting report received', trigger: 'Sent when a tasting report is submitted.', portalDestination: '/taster/tastings', adminDestination: '/admin/automations/emails' },
  { id: 'email:taster_invoice', channel: 'Email', audience: 'Internal', name: 'Taster invoice submitted', trigger: 'Sent to accounting when a taster submits an invoice.', portalDestination: '/admin/invoicing', adminDestination: '/admin/automations/emails' },
  { id: 'email:wholesale_request', channel: 'Email', audience: 'Internal', name: 'Wholesale request received', trigger: 'Sent when a new wholesaler request is submitted.', portalDestination: '/admin/wholesale-requests', adminDestination: '/admin/automations/emails' },
  { id: 'email:internal_alert', channel: 'Email', audience: 'Staff/Admin', name: 'Internal alert', trigger: 'Used for tasting decline and operational alert workflows.', portalDestination: '/admin/attention', adminDestination: '/admin/automations/emails' },
] as const
