...
const ALLOWED_FOLDERS = new Set(['order-documents', 'uploads', 'avatars', 'documents', 'tastings', 'events', 'products', 'sales-routes', 'deliveries', 'account-media', 'promotion-catalog'])
