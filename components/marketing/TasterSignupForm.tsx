...
export function TasterSignupForm() {
    ...
    return (
      <div className="space-y-4 rounded-3xl border border-emerald-200 bg-white p-8 text-center shadow-[0_24px_60px_-32px_rgba(15,23,42,0.35)]">
        ...
        <div className="space-y-2">
          <p className="text-xl font-bold text-slate-900">Taster account created!</p>
  ...
  return (
    <div className="space-y-1 rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_24px_60px_-32px_rgba(15,23,42,0.35)] sm:p-8">
      <p className="mb-2 text-xs font-semibold uppercase tracking-[0.2em] text-blue-700">Taster Sign Up</p>
      <p className="mb-2 text-lg font-bold text-slate-900">Create your taster account</p>
      <p className="mb-4 text-sm text-slate-600">For AHAWC tasting staff and brand ambassadors only. You need an invite code from the team.</p>
